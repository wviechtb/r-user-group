This is the [website](https://wviechtb.github.io/r-user-group/) and [GitHub repository](https://github.com/wviechtb/r-user-group) for the **R User Group at Maastricht University** (RUG@UM).
